...
def convert(input_filename, mgf_filename, batch_filename, pi_name, collector_name):
    ...
    try:
        ...
        raise Exception("NIST compatible .msp format error in file {}".format(str(input_filename))) from e

    # all lines processed - return number of entries
    if number_of_entries == 0:
        raise Exception("No NIST compatible .msp entries in file {}".format(str(input_filename)))
    else:
