...
def write_description(param_xml_filename, output_description_filename):
    ...
    output_sentences.append('The molecular networking job can be publicly accessed at https://gnps.ucsd.edu/ProteoSAFe/status.jsp?task={} (we recommend sharing this link in your manuscript).' .format(param_obj["task"][0]))
