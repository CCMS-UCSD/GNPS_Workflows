...
output_sentences.append("The molecular networks were visualized using Cytoscape software (Shannon, P. et al. Genome Res. 13, 2498-2504 (2003), https://dx.doi.org/10.1101/gr.1239303), and/or the Cytoscape tools for the web-based visualization F1000Res. 3, 143 (2014), http://dx.doi.org/10.12688/f1000research.4510.2.")
...
output_sentences.append("If you used the Cytoscape software:  Shannon, P. et al. Cytoscape: a software environment for integrated models of biomolecular interaction networks. Genome Res. 13, 2498-2504 (2003), https://dx.doi.org/10.1101/gr.1239303")
output_sentences.append("If you used the network web-based visualiser:  Ono, K., Demchak, B. and Ideker, T. Cytoscape tools for the web age: D3.js and Cytoscape.js exporters. F1000Res. 3, 143 (2014), http://dx.doi.org/10.12688/f1000research.4510.2")
