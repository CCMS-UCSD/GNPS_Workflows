...
def write_description(param_xml_filename, output_description_filename):
    ...
    output_sentences.append('The molecular networking job can be publicly accessed at <a href="https://gnps.ucsd.edu/ProteoSAFe/status.jsp?task={}"></a> (we recommend sharing this link in your manuscript).' .format(param_obj["task"][0]))
    #CITATIONS
