...
@purpose: to convert the XCMS-(CAMERA)-(IIN) output into a diserable format
"""
...
def convert_to_feature_csv(input_filename, output_filename):
        ...
        if input_format_df.columns[0] == 'Row.names':
        ...
        #Check and convert for XCMS-CAMERA for IINxFBMN
        elif input_format_df.columns[0] == 'mzmed':
            ...
            print('The format of the input feature quantification table is incorrect')
