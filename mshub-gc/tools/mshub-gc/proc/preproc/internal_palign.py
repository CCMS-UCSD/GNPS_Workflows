...
"""
******************************************************************************
Internal per sample peak alignment module for chromatography 
- mass spectrometry data
******************************************************************************

Experimental module to try intra peak alignment for bad data
The module is designed to adjust for chromatographic peak position variations 
at full profile resolution

run python.exe internal_palign.py --help to get info about parameters of the script
...
from proc.procconfig import InternalAlign_options
